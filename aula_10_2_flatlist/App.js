...
import {SafeAreaView, StyleSheet, Text, View, FlatList, Pressable, Image, ScrollView} from 'react-native';
...
const App = () => {
    ...
    const ListaPersonagensVertical = () => {
        return (
            <FlatList
                data={DATA}
                renderItem={Personagem}
                keyExtractor={item => item.id}
                ListFooterComponent={<ListaPersonagensHorizontal/>}
            />
        );
    }

    const ListaPersonagensHorizontal = () => {
        return (
            <FlatList
                data={DATA}
                renderItem={Personagem}
